...
write.csv(prev_asma_2013_2019, file = file.path(tabelas_dir, "df_prev_asma_2013_2019_long.csv"), row.names = FALSE)
...
write_xlsx(prev_asma_2013_2019_wide, path = file.path(tabelas_dir, "df_prev_asma_2013_2019_wide.xlsx"))
